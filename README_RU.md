...
&nbsp;
### В папке "components" лежат два файла: "Header.scss" - стили для главного заголовка страницы; "Footer.scss" - стили для главного подвала страницы. Эти компоненты присутсвуют во всех моих приложениях для общего для всех заголовка и подвала, и не являются частью приложения.
